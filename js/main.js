...
(function($) {
  ...
  $('.popup-youtube, .popup-vimeo, .popup-gmaps').magnificPopup({
	...
	function makeTimer() {
		...
		var endTime = new Date("30 August 2020 0:00:00 GMT+01:00");			
		...
		$("#dias").html(dias + "<span>dias</span>");
		$("#horas").html(horas + "<span>horas</span>");
		$("#minutos").html(minutos + "<span>minutos</span>");
		$("#segundos").html(segundos + "<span>segundos</span>");		
